    ...
    <section id="team" className="py-12 sm:py-16 md:py-20 bg-primary px-4 sm:px-6 md:px-20 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 mb-12 sm:mb-16 max-w-4xl mx-auto">
        <div className="flex flex-col items-center">
          <img src="/Youth/co-founder.png" alt="Oybek" className="w-48 h-60 sm:w-56 sm:h-70 md:w-64 md:h-80 object-cover rounded-2xl shadow-lg invisible-until-scroll" style={{ transitionDelay: '0.1s' }} />
        ...
        <div className="flex flex-col items-center">
          <img src="/Youth/founder.png" alt="Nozanin" className="w-48 h-60 sm:w-56 sm:h-70 md:w-64 md:h-80 object-cover rounded-2xl shadow-lg invisible-until-scroll" style={{ transitionDelay: '0.1s' }} />
