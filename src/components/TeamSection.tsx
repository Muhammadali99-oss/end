    ...
    <section id="team" className="py-8 sm:py-12 md:py-16 lg:py-20 bg-primary px-3 sm:px-4 md:px-6 lg:px-8 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 mb-8 sm:mb-12 md:mb-16 max-w-4xl mx-auto">
        <div className="flex flex-col items-center">
          <img src={`${import.meta.env.BASE_URL}co-founder.png`} alt="Oybek" className="w-40 h-48 sm:w-48 sm:h-60 md:w-56 md:h-70 lg:w-64 lg:h-80 object-cover rounded-2xl shadow-lg invisible-until-scroll" style={{ transitionDelay: '0.1s' }} />
        ...
        <div className="flex flex-col items-center">
          <img src={`${import.meta.env.BASE_URL}founder.png`} alt="Nozanin" className="w-40 h-48 sm:w-48 sm:h-60 md:w-56 md:h-70 lg:w-64 lg:h-80 object-cover rounded-2xl shadow-lg invisible-until-scroll" style={{ transitionDelay: '0.1s' }} />
