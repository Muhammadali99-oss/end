  ...
  const programs = [
    {
      ...
      icon: Trophy,
        image: `${import.meta.env.BASE_URL}Debate.JPG`,
    ...
    },
    {
      ...
      icon: Zap,
        image: `${import.meta.env.BASE_URL}Debathons.JPG`,
    ...
    },
    {
      ...
      icon: GraduationCap,
        image: `${import.meta.env.BASE_URL}Trainings.JPG`,
    ...
    },
    {
      ...
      icon: Mic,
        image: `${import.meta.env.BASE_URL}Confidenceonstage.JPG`,
